...
switch_pattern = out.switchPatterns.Data(1:20:end,:);
disp(switch_pattern)
...
l1 = 0.7;
ro = out.thetaAngle.Data(1)*pi/180;
...
ro1 = out.thetaAngle.Data(1:2:end);
ro2 = out.rpm.Data(1:2:end);
figure
plot(ro2);



switch_pattern = switch_pattern(1:end);
for l = 1:numel(ro1)
